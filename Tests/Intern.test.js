...
test('Can add school name with constructor ', () => {
    ...
    const testArtist = new Intern("Sammy", "43593784509378", testSchool);
...
const testArtist = new Intern("Sammy", "0909090", "sammy@circus.com");
...
const testArtist = new Intern("Sammy", "67676767", testSchool);
